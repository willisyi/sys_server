...
typedef struct StreamEnv_t{
	...
	unsigned char nVideocodec;//for 8168?
	unsigned char nVideocodecmode;// 8168?
	unsigned char nVideocodecres;//8168?
	unsigned char nVideocodeclevel; // add by lyy
	...
	unsigned char nRateControl1;//for 8168?
	unsigned char nRateControl2;
	unsigned char nFrameRate1;//for 8168?
	...
	unsigned char audioenable;//for 8168?
	unsigned char audiocodectype;//8168?
	unsigned char audiobitrate;//8168?
	unsigned char audioinvolume;//8168?
	unsigned char audiooutvolume;//8168?
	unsigned char audioSampleRate;//8168?
...
extern const unsigned int enc_framerate_day_1_dm8168[2][6][5];
extern const unsigned int enc_framerate_day_2_dm8168[2][6][5];
extern const unsigned int enc_framerate_day_3_dm8168[2][6][5];
extern const unsigned int enc_framerate_night_1_dm8168[2][6][5];
extern const unsigned int enc_framerate_night_2_dm8168[2][6][5];
extern const unsigned int enc_framerate_night_3_dm8168[2][6][5];
...
int closeAV_server(void);      //set by cmj
